...
2. The reference of super class can be used to access
...
3. The reference of super class obj cannot be used to
   access the individual methods of sub class( a    method which is there only in sub class not not      present in super class)
	 * 
	 * 
	 */
